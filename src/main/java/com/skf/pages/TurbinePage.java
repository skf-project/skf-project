...
public class TurbinePage extends Page {
	...
	public WebElement eventworkorderlabel() {
		return driver.findElement(By.xpath(
				"//div[@class='Breadcrumb-module_breadcrumb__2Mkgj']//a[contains(text(),'Event & Work Orders')]"));
	}

	public WebElement skflink() {
		return driver.findElement(By.cssSelector(
				"#root > div:nth-child(2) > div.Navigator-module_navigator__1WRTE.undefined > div > ul > li.Navigator-module_logo__1bP1h"));
	}
